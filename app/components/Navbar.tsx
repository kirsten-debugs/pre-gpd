...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 z-50 w-full transition-[backdrop-filter] duration-500 ${isScrolled || isOpen ? "bg-background/70 backdrop-blur-xl border-b border-border" : "bg-transparent border-b border-transparent"}`}>
